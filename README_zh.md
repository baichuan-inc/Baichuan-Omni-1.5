...
- **强大的真实世界理解能力及其他功能。**
Baichuan-Omni-1.5 进一步优化了 Baichuan-omni 的众多视觉理解能力，其可以处理任意长宽比的图像，像素数可达 180 万（如 1344x1344）。在 RealWorldQA 上取得**68.8分的成绩，超过 GPT-4o-mini 等商用闭源模型以及开源的全模态模型。在MMBench上的英文/中文评测子集分别取得85.4/85.0的高分**。
